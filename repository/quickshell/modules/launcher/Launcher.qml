...
Item {
  Layout.fillWidth: true
    ...
    property var filteredApps: {
        ...
        if (!q) return LauncherService.apps
        return LauncherService.apps.filter(app =>
    ...
    function toggle() {
        if (GlobalState.isLauncherOpen) close()
        else open()
    }

    function open() {
        if (GlobalState.isLauncherOpen) return
                ...
                Item {
                    ...
                    Rectangle {
                        ...
                        Image {
                            ...
                            source: LauncherService.iconForAppMeta(delegateRoot.app)
                    ...
                    MouseArea {
                        ...
                        onClicked: LauncherService.launchApp(root.filteredApps[index])
                    }
                }
            }
    ...
    ParallelAnimation {
        ...
        onFinished: GlobalState.isLauncherOpen = false
    }
